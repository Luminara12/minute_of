...
{
  // debugger;
  console.log('showPopup is opened')
...
export {GeneralHeader, AlertItem, ModalDebug, add_evg_func, revert_to_old_debug, exec_evg_func, get_evg_func, send_object, press_on_item, show_alert, show_legend, hide_legend, show_info, hide_info, get_random_string, Junk, showPopUp, hidePopUp};
